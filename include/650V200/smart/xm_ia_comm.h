...
typedef enum
{
    ...
    XM_IA_PLATFORM_XM350AIV3 = 53,          /* XM350AIV3,与XM530V200同代芯片 */
    ...
    /* XM530V300Pro系列 */
    XM_IA_PLATFORM_XM535W1 = 100,           /* XM535W1 */
...
typedef enum
{
    ...
    XM_IA_RIDER = 0x02,                 /* 骑车人（骑自行车或电瓶车的人和车整体） */
    XM_IA_VEHICLE = 0x10,               /* 汽车,比如0x11可表示成小轿车、0x12可表示成SUV,暂时不用 */
    XM_IA_FORKLIFT = 0x14,              /* 叉车 */
    XM_IA_NONMOTOR = 0x20,              /* 自行车 */
    XM_IA_MOTOR = 0x25,                 /* 电瓶车、摩托车 */
    XM_IA_SPEED_SIGN = 0x30,            /* 交通限速牌 */
    XM_IA_PET = 0x50,                   /* 宠物（猫狗） */
    XM_IA_HAND = 0x60,                  /* 手掌 */
    XM_IA_PACKAGE = 0x90,               /* 包裹 */
...
typedef enum
{
    ...
    /* YUV420 */
    XM_IMG_TYPE_YUV420SP = 0x10,    /* YUV420P型图像(枚举类型名字起错) */
    ...
    XM_IMG_TYPE_S8C3_PLN = 0x58,     /* 三通道8bit Planar型图像,BGR序 BBBGGGRRR */
...
typedef struct
{
    ...
    unsigned int u32BufferSize;     /* 图像创建时所占用的内存 */
